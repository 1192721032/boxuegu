define(['aside', 'header', 'loading', 'nprogress', 'jquery', 'template'], 
    function(undefined, undefined, undefined, nprogress, $, template) {
        /**
    ...
    //     $(document).on('submit','#teacher-add-edit-form',
    //     function(){
    //         $.post('/v6/teacher/add',$(this).serialize(),
    //         function(data){
    //             location.href = 
    //             '/html/teacher/teacher_list.html';
    //         });
    //         return false;
    //     });
    // };
